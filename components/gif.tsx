...
import { ExternalLink, Laugh, Loader2 } from "lucide-react"
...
function GifOutput({ src, url, provider, children }: PhotoProps) {
  return (
    <>
      <div className="absolute left-2 top-2 z-20 rounded-full bg-white/40 p-3">
        <Laugh className="h-4 w-4 text-gray-600 dark:text-gray-900" />
      </div>
